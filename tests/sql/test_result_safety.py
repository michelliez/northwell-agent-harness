...
def test_verify_rejects_sensitive_column_in_result() -> None:
    ...
    result = [
        {"DEPT_ID": "CARDIOLOGY", "total_count": 42, "PATIENT_SSN": "123-45-6789"}
    ]
...
def test_verify_rejects_identifier_column_in_result() -> None:
    ...
    result = [
        {"DEPT_ID": "CARDIOLOGY", "total_count": 42, "INTERNAL_ID": 12345}
    ]
...
def test_verify_rejects_unmapped_column() -> None:
    ...
    result = [
        {"DEPT_ID": "CARDIOLOGY", "total_count": 42, "UNKNOWN_COL": "value"}
    ]
