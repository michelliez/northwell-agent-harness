...
from policy.result import PolicyFinding, PolicyGateResult
...
POLICY_CHECKS: tuple[PolicyCheckEntry, ...] = (
    ...
    (
        "operational_risk.local_execution_and_exfiltration",
        operational_risk.check_local_execution_and_exfiltration,
    ),
