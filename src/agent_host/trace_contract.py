...
TraceEventName = Literal[
    ...
    "query_plan.error",
    "query_plan.repair_attempted",
    "plan_safety.approved",
    "plan_safety.no_plan",
    "plan_safety.rejected",
    "generate_sql.completed",
    "generate_sql.no_plan",
    "write_sql.compiler_unsupported",
    "validate_sql.completed",
    "validate_sql.no_sql",
    "validate_sql.failed_final",
    "validate_sql.error",
    "cost_execution_gate.missing_evidence",
    "cost_execution_gate.config_error",
    "cost_execution_gate.rejected",
...
EVENT_SPEC: dict[TraceEventName, EventSpec] = {
    ...
    "intent.started": _s("intent", "ok", "Intent classification started"),
    "intent.classified": _s("intent", "ok", "Intent classified", True),
    "intent.question_resolved": _s(
        "intent", "ok", "Referential question resolved to concrete form", True
    ),
    ...
    "retrieval.chunk_blocked": _s("retrieval", "blocked", "Chunk blocked by content screen"),
    ...
    "context_gate.started": _s("retrieval", "ok", "Context assessment started"),
    "context_gate.completed": _s("retrieval", "ok", "Context assessment completed"),
    "exploration.started": _s("retrieval", "ok", "Exploration started", True),
    "exploration.completed": _s("retrieval", "ok", "Exploration completed", True),
    "exploration.truncated": _s("retrieval", "blocked", "Exploration cut short by budget", True),
    ...
    "validate_sql.error": _s("sql", "error", "SQL validation threw unexpectedly"),
    "cost_execution_gate.missing_evidence": _s("sql", "blocked", "Dry-run evidence missing"),
    "cost_execution_gate.config_error": _s("sql", "error", "Cost controls unavailable"),
    "cost_execution_gate.rejected": _s("sql", "blocked", "Cost approval rejected"),
    "cost_execution_gate.approved": _s("sql", "ok", "Cost approval issued"),
