...
TraceEventName = Literal[
    ...
    "fix_sql.missing_state",
    "fix_sql.error",
    "fix_sql.loop_detected",
    "fix_sql.completed",
...
EVENT_SPEC: dict[TraceEventName, EventSpec] = {
    ...
    "fix_sql.missing_state": _s("sql", "blocked", "SQL repair state missing"),
    "fix_sql.error": _s("sql", "error", "SQL repair failed"),
    "fix_sql.loop_detected": _s("sql", "blocked", "SQL repair loop detected"),
    "fix_sql.completed": _s("sql", "ok", "SQL repaired", True),
